...
//
// **Direct port** of the canonical TypeScript source at
// `the-librarian/integrations/shared/librarian-lifecycle/src/privacy.ts`.
// This file should be byte-identical to the canonical source (modulo this
// header comment) — `scripts/validate.ts` enforces that. If you change
// this file, change the canonical source in the same coordinated PR;
// otherwise the privacy detector drifts across harnesses and behaviour
// silently diverges (a category of bug we cannot accept — see AGENTS.md
// §2 "Privacy beats convenience").
//
// The same file is also ported to Python in the-librarian-hermes-plugin
// (`privacy.py`) and to JS in the-librarian-codex-plugin
// (`src/privacy-detector.mjs`). All four are kept in lockstep.
//
// --- canonical source begins ---
